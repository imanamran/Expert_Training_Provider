        ...
        <div class="container">
            <div class="row mb-5">
                <div class="col-md-8 col-xl-6 text-center mx-auto">
                    <h2>Need help? Do contact us!</h2>
                    <p style="padding-left: 70px;padding-right: 70px;">&quot;Knowledge is power, and power is the tool with which we can reshape the world.&quot;<br />- Stalin -</p>
                </div>
            </div>
                    ...
                    <div class="d-flex flex-column justify-content-center align-items-start h-100">
                        ...
                        <div class="d-flex align-items-center p-3">
                            ...
                            <div class="px-2">
                                ...
                                <p class="mb-0">expert@training.com</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center p-3">
                            ...
                            <div class="px-2">
                                ...
                                <p class="mb-0">J<span style="color: rgb(17, 17, 17);">alan Simpang Tiga, 93350 Kuching, Sarawak</span></p>
                            </div>
                        </div>
                    </div>
                </div>
