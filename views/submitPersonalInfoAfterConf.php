    ...
    <div class="container pt-5">
        <div class="row pt-5">
            ...
            <div class="col-lg-10 ms-auto position-relative">
                <img src="assets/img/inclusive.jpg" class="rounded-3" alt="">
				...
				<div class="col-11 col-sm-10 col-lg-8 col-xl-6 position-lg-middle ms-lg-8 ms-xl-7">
					<div class="card shadow pb-0 mt-n7 mt-sm-n8 mt-lg-0">
                        ...
                        <!-- Card body START -->
                        <form class="bg-secondary card-body form-control-border p-2 p-sm-2">
                            <!-- Tabs content START -->
                            <div class="d-flex">
                                <!-- Left Div START -->
                                <div class="left m-2">
                                    ...
                                    <div class="mb-3 mt-3">
                                        ...
                                        <div class="d-flex justify-content-around">
                                            <div>
                                                <input type="radio" class="btn-check" value="Yes" name="room_needed" id="room_needed" autocomplete="off">
                                                <label class="btn btn-secondary" for="room_needed">Yes</label>
                                            </div>
                                            <div>
                                                <input type="radio" class="btn-check" value="No" name="room_not_needed" id="room_not_needed" autocomplete="off">
                                                <label class="btn btn-secondary" for="room_not_needed">No</label>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="right m-2">
                                    ...
                                    <!-- <div class="mb-3 mt-3">
                                        ...
                                        <ul class="list-inline mb-0 mt-3">
                                            <li class="list-inline-item"> <button class="btn btn-primary text-light" >Paypal<i class="bi bi-paypal"></i></button></li>
                                            <li class="list-inline-item"> <button class="btn btn-primary text-light" >Credit/Debit<i class="bi bi-credit-card"></i></i></button></li>
                            ...
                            <!-- Button -->
                            <div class="d-grid">
                                <a href="<?php echo ""; ?>" class="btn btn-dark mb-0">Proceed To Payment</a>
                            </div>
